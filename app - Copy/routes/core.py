    ...
    for file in files:
        ...
        if filename.endswith(".csv"):
            ...
            if filename.endswith(".pdf"):
                ...
                raw_texts = [ResumeParserService.parse_docx(file_bytes)]
...
def compute_rankings(job_id: int, db: Session = Depends(get_db), current_user: User = Depends(require_recruiter)):
